package it.siw.viaggi.authentication;

import static it.siw.viaggi.model.Credentials.ADMIN_ROLE;
import static it.siw.viaggi.model.Credentials.DEFAULT_ROLE;
...
public class AuthenticationConfiguration extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		// solo gli utenti autenticati con ruolo ADMIN o DEFAULT possono accedere a risorse con path /admin/**
		.antMatchers(HttpMethod.GET, "/protected/**").hasAnyAuthority(Credentials.ADMIN_ROLE, Credentials.DEFAULT_ROLE)
